 ...
 */
public class SubjectProductAdapter extends BaseAdapter {
        ...
        if (!requestSet.contains(lssueId)) {
            ...
            ProductManager.getWinnerInfo(lssueId).startUI(new ApiCallback<OwnerExtVO>() {
                ...
                public void onSuccess(OwnerExtVO ownerExtVO) {
                    ...
                    SubjectProductAdapter.this.notifyDataSetChanged();
                }
    ...
    public SubjectProductAdapter(BuyCarType buyCarType, Context context, List<WinningInfo> records, ImageLoader imageLoader) {
    ...
    public void addAll(List<WinningInfo> products, boolean needClear) {
        ...
        if(products == null) {
            products = new ArrayList<WinningInfo>();
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.subject_product_item, null);
