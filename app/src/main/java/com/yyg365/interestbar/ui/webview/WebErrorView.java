...
/**
 * 当webview触发 onReceivedError 时，出现的错误页面
 */
public class WebErrorView extends RelativeLayout {

    public WebErrorView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        LayoutParams lpTxt = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        lpTxt.addRule(RelativeLayout.CENTER_HORIZONTAL);
        lpTxt.addRule(RelativeLayout.BELOW, 130);
        this.addView(txt, lpTxt);
    }
