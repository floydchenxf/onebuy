...
public class AlertController {
	...
	private int m_MyAlertContentViewId;
	...
	public AlertController(Context context, DialogInterface di, Window window) {
		m_MyAlertContentViewId = R.layout.alert_dialog;
		mContext = context;
		mDialogInterface = di;
		mWindow = window;
	...
	private void setBackground(LinearLayout topPanel,
		...
		// int fullDark = R.drawable.wx_popup_full;
		// int topDark = R.drawable.wx_popup_top;
		// int centerDark = R.drawable.wx_popup_center;
		// int bottomDark = R.drawable.wx_popup_bottom;
		// int fullBright = R.drawable.wx_popup_full;
		// int topBright = R.drawable.wx_popup_top;
		// int centerBright = R.drawable.wx_popup_center;
		// int bottomBright = R.drawable.wx_popup_bottom;
		// int bottomMedium = R.drawable.wx_popup_bottom;
	...
	public static class AlertParams {
		...
		private void createListView(final AlertController dialog) {
			...
			if (mIsMultiChoice) {
				...
				int layout = mIsSingleChoice ? R.layout.select_dialog_singlechoice: R.layout.select_dialog_item;
				if (mCursor == null) {
