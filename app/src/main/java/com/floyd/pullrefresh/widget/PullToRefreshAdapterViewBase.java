...
//	private IndicatorLayout mIndicatorIvBottom;
	...
	PullToRefreshAdapterViewBase(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}
...
//		if (DEBUG) {
//			WxLog.d(LOG_TAG, "First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount
...
//			removeIndicatorViews();
	...
	protected void addRefreshableView(Context context, T refreshableView) {
		...
		mRefreshableViewHolder.addView(refreshableView, ViewGroup.LayoutParams.FILL_PARENT,
				ViewGroup.LayoutParams.FILL_PARENT);
		addView(mRefreshableViewHolder, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, 0, 1.0f));
	}
...
//			}
	...
	protected void onReleaseToRefresh() {
		...
		Log.d("setting", "onReleaseToRefresh");
...
//		if (DEBUG) {
//			WxLog.d(LOG_TAG, "isLastItemVisible. Count: " + count + " Last Visible Pos: " + lastVisiblePosition);
//		}
