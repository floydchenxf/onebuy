package com.floyd.onebuy.ui.pageindicator;
 ...
 */
public class CircleLoopPageIndicator extends View
{
    ...
    private int mFocusColor = Color.parseColor("#b3ffffff");

    private int mFocusStrokeColor = Color.parseColor("#eeeeee");


    private int mUnfocusColor = Color.parseColor("#0c000000");

    private int mStrokeColor = Color.parseColor("#b3ffffff");
...
//            mStrokeColor = res.getColor(R.color.default_circle_indicator_stroke_color);
            mStrokeWidth = res.getDimension(R.dimen.default_circle_indicator_stroke_width);
            judgeIndex();
        ...
        if (mTotal > 1)
        {
            ...
            for (int i = 0; i < mTotal; i++)
            {
                if (i == mIndex)
                {
                    ...
                    mPaint.setColor(mFocusStrokeColor);
